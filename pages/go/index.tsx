        ...
        <div className={styles.inner}>
          {[
            ...
            item === "app" ? (
                ...
                {!!blogRef.current ? (
                  <div>
                    <Typography.Paragraph strong>
                      自 博客导航 跳转至{" "}
                      <a
                        href={blogRef.current.url}
                      >{`${blogRef.current.name} (${blogRef.current.url})`}</a>
                    </Typography.Paragraph>
                    <Typography.Paragraph strong>
                      {ts > 0 ? `${ts} 秒后自动跳转` : "正在跳转..."}{" "}
                    </Typography.Paragraph>
              ...
              >
                <div className={styles.box_card_1}></div>
                <br />
                <div className={styles.box_card_2}></div>
                <br />
